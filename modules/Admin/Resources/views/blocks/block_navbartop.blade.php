<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header">
        ...
        <div class="top-left-part"><a class="logo" href="{{ route('admincpp.getHomeAdmin') }}"><b><img src="{{ asset('backend/imgs/eliteadmin-logo.png') }}" alt="home" /></b><span class="hidden-xs"><strong>Cook</strong>Friend</span></a></div>
