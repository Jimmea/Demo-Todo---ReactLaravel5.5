                ...
                <div class="white-box-content ">
                    <table class="table table-stripped" id="dataTableList">
                        ...
                        <tr>
                            ...
                            <td width="4%" align="center" class="bold">Hình ảnh</td>
                            <td width="15%" class="bold">Tiêu đề</td>
                            <td width="25%" class="bold">Đi tới</td>
                        ...
                        @foreach($menus as $value)
                            ...
                            <tr id="tr_{{ $value['mnu_id'] }}">
                                ...
                                <td align="center"><img src="{{ $value['mnu_picture'] }}" class="img9070 img-responsive"></td>
