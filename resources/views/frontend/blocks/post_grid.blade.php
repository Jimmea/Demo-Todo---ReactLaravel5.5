<section id="grid" data-columns="4" class="grid salvattore-grid grid-fixed">
	<div class="column size-1of4">
		<article class="grid-col--fixed-tiles">
			...
			<a ng-class="{ highlighted : saved }" title="Save this recipe" data-ng-show="showHeart" class="favorite ng-isolate-scope" data-id="245931" data-type="'Recipe'" data-name="&quot;Game Day Chili Pups&quot;" data-imageurl="'http://images.media-allrecipes.com/userphotos/250x250/4460060.jpg'"><span class="ng-binding"></span></a>
			...
			<img class="grid-col__rec-image ng-isolate-scope" data-lazy-load="" data-original-src="http://images.media-allrecipes.com/userphotos/250x250/4460060.jpg" alt="Game Day Chili Pups Recipe and Video - Tailgating or checking out the game at home, these mini chili pups are smoky, spicy and delicious. Great for snacking before the touchdown." title="Game Day Chili Pups Recipe and Video" src="http://images.media-allrecipes.com/userphotos/250x250/4460060.jpg" style="display: inline;">
			...
			<a href="/recipe/245931/game-day-chili-pups/?internalSource=rotd&amp;referringContentType=home page&amp;clickId=cardslot 1" data-internal-referrer-link="rotd" data-click-id="cardslot 1" class="ng-isolate-scope" target="_self">
				<div class="grid-col__ratings">
					...
					<span class="grid-col__reviews">1</span>
					<div data-merch-type="Ads_LogoScroller_122x34" style="margin: auto; margin-left: .5rem; display: inline-block; width: 122px; height: 34px">
						...
						<div id="div-gpt-sponsorLogo" data-tier="1" data-google-query-id="CI2O5rrry9ECFY2avAodrOgN1A">
							<div id="google_ads_iframe_3865/ar.mdp.com/tier1/homepage/home_0__container__" style="border: 0pt none;"><iframe id="google_ads_iframe_3865/ar.mdp.com/tier1/homepage/home_0" title="3rd party ad content" name="google_ads_iframe_3865/ar.mdp.com/tier1/homepage/home_0" width="122" height="34" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" srcdoc="" style="border: 0px; vertical-align: bottom;" _fsrb="true"></iframe></div>
						</div>
						<div id="div-gpt-mob-sponsorLogo" data-tier="1"></div>
					</div>
					<div class="rec-card__description">Tailgating or checking out the game at home, these mini chili pups are smoky, spicy and delicious. Great for snacking before the touchdown.</div>
				</div>
			</a>
			<div class="profile profile--recipe-card">
				<a href="/cook/hillshirefarm/?internalSource=rotd&amp;referringContentType=home page&amp;clickId=cardslot 1" data-internal-referrer-link="rotd" data-click-id="cardslot 1" class="ng-isolate-scope" target="_self">
					<ul class="cook-details">
						<li>
							<img class="img-profile elevate-cook-thumbnail fsrHidden" alt="profile image" src="http://images.media-allrecipes.com/userphotos/50x50/4454556.jpg">
						</li>
						<li>
							<h4><span>Recipe by</span> Hillshire Farm®</h4>
