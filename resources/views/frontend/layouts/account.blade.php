...
<div class="container-content body-content">
	...
	<div data-ng-controller="ar_controllers_private_profile_nav" data-ng-init="init()" class="ng-scope">
		<ul class="profile-subnav">
			<li data-ng-class="{selected: selectedSubNav === 'about-me'}" ng-click="sendAnalyticsBeacon()">
				<a href="{{ route('account::about') }}" data-spa="true" ng-click="setSubNav('about-me')">About Me</a>
			</li>
			<li data-ng-class="{selected: selectedSubNav === 'favorites'}" ng-click="sendAnalyticsBeacon()" class="selected">
				<a href="{{ route('account::collection') }}" data-spa="true" ng-click="setSubNav('favorites')">Favorites</a>
			</li>
			<li data-ng-class="{selected: selectedSubNav === 'followers'  || selectedSubNav === 'following' || selectedSubNav === 'findfriends'}" ng-click="sendAnalyticsBeacon()">
				<a href="{{ route('account::friend') }}" data-spa="true" ng-click="setSubNav('followers')">Friends</a>
			</li>
			<li data-ng-class="{selected: selectedSubNav === 'made-it'}" ng-click="sendAnalyticsBeacon()">
				<a href="{{ route('account::made') }}" data-spa="true" ng-click="setSubNav('made-it')">I Made It</a>
			</li>
			<li data-ng-class="{selected: selectedSubNav === 'photos'}" ng-click="sendAnalyticsBeacon()">
				<a href="{{ route('account::photo') }}" data-spa="true" ng-click="setSubNav('photos')">My Photos</a>
			</li>
			<li data-ng-class="{selected: selectedSubNav === 'reviews'}" ng-click="sendAnalyticsBeacon()">
				<a href="{{ route('account::review') }}" data-spa="true" ng-click="setSubNav('reviews')">My Reviews</a>
			</li>
			<li data-ng-class="{selected: selectedSubNav === 'recipes'}" ng-click="sendAnalyticsBeacon()">
				<a href="{{ route('account::recipe') }}" data-spa="true" ng-click="setSubNav('recipes')">Personal Recipes</a>
			</li>
		</ul>
	</div>
