...
abstract class BaseFileController
{
    ...
    /**
     * Get extension file by filename
    ...
    /**
     * Kiem tra extension truyen vao co hop le voi yeu cau khong
     * @param array $extensionList : mang extension yeu cau
     * @return int
     */
    public function checkExtensionFile($extensionList= array())
    {
    ...
    /**
     * Tao mot folder ung voi thu duong dan duoc truyen vao
     * @param string $path : duong dan file
     * @return void
     */
    ...
    /**
     * Kiem tra va tao folder neu chua ton ta
     * @param string $uploadPath : ten folder chua duong dan
     * @return string
     */
    ...
    /**
     * Check upload file path thanh cong khong
    ...
    /**
     * Make full path with 2 parammeter
     * @param string $path
